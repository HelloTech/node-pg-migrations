...
const addMigration = function(fileName){
    const curDate = new Date();
    const name = `./migrations/${curDate.getFullYear()}${curDate.getMonth()}${curDate.getMonth() + 1}${curDate.getDate()}${curDate.getHours()}${curDate.getMinutes()}${curDate.getSeconds()}_${fileName}`;
